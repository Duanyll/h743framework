...
void AD9834_Init(AD9834_Pins *p) {
  ...
  GPIO_InitStruct.Pin = pins->FSY_Pin;
  HAL_GPIO_Init(pins->FSY_Port, &GPIO_InitStruct);
  GPIO_InitStruct.Pin = pins->SCK_Pin;
  HAL_GPIO_Init(pins->SCK_Port, &GPIO_InitStruct);
  GPIO_InitStruct.Pin = pins->SDA_Pin;
  HAL_GPIO_Init(pins->SDA_Port, &GPIO_InitStruct);

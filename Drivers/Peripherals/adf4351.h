...
typedef union {
    struct {
        ...
        uint32_t
            PhaseVal : 12;      /*!< bit: 15..26 	12-BIT PHASE VALUE (PHASE) */
...
typedef union {
    struct {
        uint32_t ControlBits : 3; /*!< bit:  0.. 2 	CONTROL BITS */
        uint32_t
            CounterReset : 1;       /*!< bit:  3 		 	Counter Reset */
        ...
        uint32_t LockFunction : 1;  /*!< bit:  8 		 	Lock Detect
                                     ...
                                     */
        uint32_t
            CPCurrent : 4; /*!< bit:  9..12 	Charge Pump Current Setting */
        uint32_t
            DoubleBuffer : 1;    /*!< bit:  13		 	Double Buffer */
        ...
        uint32_t
            LowNoiseSpur : 2; /*!< bit: 29..30	Low Noise and Low Spur Modes  */
        uint32_t _reserved_0 : 1; /*!< bit: 31			RESERVED  */
    };
    uint32_t w;
} ADF4351_Reg2_t;
...
typedef union {
    struct {
        uint32_t ControlBits : 3; /*!< bit:  0.. 2 	CONTROL BITS */
        uint32_t
            ClkDivVal : 12;     /*!< bit:  3..14 	12-Bit Clock Divider Value */
        ...
        uint32_t
            AntibacklashW : 1;    /*!< bit:  22     Antibacklash Pulse Width */
...
double ADF4351_SetFrequency(ADF4351_Config *config, double rfout, double refin, double fresout);
